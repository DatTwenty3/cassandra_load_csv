...
directory_path = os.path.join(os.path.dirname(__file__), "build_load_data/result_station")
directory_path = "build_load_data/result_station"
    ...
    for file in file_list:
        with open(os.path.join(directory_path, file), 'r', newline='') as csvfile:
            ...
            for row in reader:
                ...
                cf_query = f"INSERT INTO stationbikeshare (station_id, station_name, city, country) VALUES (%s, %s, %s, %s)"
                batch.add(cf_query, (station_id, station_name, city, country))
